            ...
            <div className="container mx-auto flex flex-wrap justify-between">
                ...
                <div className="flex flex-col space-y-2 w-full sm:w-1/3 text-center sm:text-left">
                    ...
                    <p className="text-sm sm:text-base">
                        ...
                        <a href="mailto:medicineuzh@ukr.net" className="text-green-400 hover:text-green-600 transition-all ml-1">
                            medicineuzh@ukr.net
                        </a>
                    </p>
                    <p className="text-sm sm:text-base">
                ...
                <div className="flex justify-center w-full sm:w-1/3">
                    <div className="w-full h-64 rounded-lg overflow-hidden shadow-lg">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4413.636734292904!2d22.302255222724155!3d48.62753853672689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473e382585ddc27d%3A0x686c441bde2385c8!2z0YPQt9C90YvQuSDQntC40Lgg0JbQuCDQs9C40YfQs9C-!5e0!3m2!1suk!2sua!4v1682790840139!5m2!1suk!2sua"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen=""
